...
public class Building5a implements Building {
	...
	public Building5a(int baseX, DrawingPanel _dp) {
		//_mp = mp;
	...
	public void repaint(Graphics2D g) {
		...
		if (_roof != null) {
			g.drawImage(_roof, _baseX, 208, null);
		}
		...
		if (_dirtRoof != null) {
			g.drawImage(_dirtRoof, _baseX, 544, null);
		}
