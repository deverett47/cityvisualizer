...
public class Building4a implements Building {
	...
	public Building4a(int baseX, DrawingPanel _dp) {
		//_mp = mp;
	...
	public void repaint(Graphics2D g) {
		...
		if (_roof != null) {
			g.drawImage(_roof, _baseX, 170, null);
		}
		...
		if (_dirtRoof != null) {
			g.drawImage(_dirtRoof, _baseX, 580, null);
		}
	...
	private void addFloorNew() {
		try {
			if (_numFloors < 12) {
				...
				BufferedImage newImage = ImageIO.read(new File("building4/floor"+rand+".png"));
				...
				_roof = ImageIO.read(new File("building4/roof.png"));
				_numFloors++;
			}
