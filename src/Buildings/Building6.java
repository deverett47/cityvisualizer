...
public class Building6 implements Building {
	...
	public Building6(int baseX, DrawingPanel _dp) {
		//_mp = mp;
	...
	public void repaint(Graphics2D g) {
		...
		if (_roof != null) {
			g.drawImage(_roof, _baseX, 33, null);
		}
		...
		if (_dirtRoof != null) {
			g.drawImage(_dirtRoof, _baseX, 632, null);
		}
	...
	private void addFloorNew() {
		try {
			if (_numFloors < 4) {
				...
				BufferedImage newImage = ImageIO.read(new File("building6/floor"+rand+".png"));
				...
				_roof = ImageIO.read(new File("building6/roof.png"));
				_numFloors++;
			}
	...
	private void addDirtNew() {
		try {
			if (_numDirt < 4) {
				int rand = new Random().nextInt(3) +1;
				System.out.println(rand);
				BufferedImage newImage = ImageIO.read(new File("building6/dirt"+rand+".png"));
				...
				_dirtRoof = ImageIO.read(new File("building6/dirtroof.png"));
				_numDirt++;
			}
