...
public class Building1 implements Building {
	...
	public Building1(int baseX, DrawingPanel _dp) {
		//_mp = mp;
	...
	public void repaint(Graphics2D g) {
		...
		if (_dirtRoof != null) {
			g.drawImage(_dirtRoof, _baseX, 655, null);
		}
	...
	private void addDirtNew() {
		try {
			if (_numDirt < 17) {
				int rand = new Random().nextInt(5) +1;
				System.out.println(rand);
				BufferedImage newImage = ImageIO.read(new File("building1/dirt"+rand+".png"));
				...
				_dirtRoof = ImageIO.read(new File("building1/dirtroof.png"));
				_numDirt++;
			}
