...
public class Building3a implements Building {
	...
	public Building3a(int baseX, DrawingPanel _dp) {
		//_mp = mp;
	...
	public void repaint(Graphics2D g) {		
		...
		if (_roof != null) {
			g.drawImage(_roof, _baseX, 28, null);
		}
		...
		if (_dirtRoof != null) {
			g.drawImage(_dirtRoof, _baseX, 752, null);
		}
	...
	private void addFloorNew() {
		try {
			if (_numFloors < 16) {
				...
				BufferedImage newImage = ImageIO.read(new File("building3/floor"+rand+".png"));
				...
				_roof = ImageIO.read(new File("building3/roof.png"));
				_numFloors++;
			}
