...
public class Building2 implements Building {
	...
	public Building2(int baseX, DrawingPanel _dp) {
		//_mp = mp;
	...
	public void repaint(Graphics2D g) {
		...
		if (_roof != null) {
			g.drawImage(_roof, _baseX, 41, null);
		}
		...
		if (_dirtRoof != null) {
			g.drawImage(_dirtRoof, _baseX, 700, null);
		}
